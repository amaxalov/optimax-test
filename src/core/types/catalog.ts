...
import { FETCH_CATALOG, FETCH_CATALOG_REJECTED, FETCH_CATALOG_SUCCESS, ADD_TO_CATALOG } from '../constants/catalog'
...
export interface IFetchCatalogRejectAction extends Action<typeof FETCH_CATALOG_REJECTED> {
